...
public class MainViewModel extends BaseObservable {
    ...
    private HomeRepoImpl mHomeRepo;
    ...
    public MainViewModel(MainViewModelComponent modelComponent, HomeUseCaseComponent useCaseComponent) {
        ...
        mHomeRepo = useCaseComponent.getRepository();
    ...
    public void getDirection(LatLng source, LatLng destination) {
        ...
        DirectionResult directionResult = mHomeRepo.getDirectionResult(source.latitude + "," + source.longitude
